<template>
  <div class="datepicker">
    <div class="datepicker-wrapper" ref="popup" v-transfer="transfer" v-show="isWrapperShow" :style="" >
      <div class="mdl-grid center-items"  @mouseover="handleMouseOver" @mouseout="handleMouseOver" v-show="displayDayView">
        <template v-for="(p, pan) in pane" >
          <div class="mdl-cell mdl-cell--4-col calendar__col--width ">
            <div class="datepicker-body calendar--width mdl-card mdl-shadow--2dp ">

              <div class="mdl-card__title" @click="switchMonthView">{{stringifyDayHeader(currDate, pan)}}</div>
...
.event-calendar .datepicker-weekRange span{
  font-weight: bold;
  font-size: 12px;
  height: 35px;
}
